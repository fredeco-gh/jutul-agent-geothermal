...
\begin{tikzpicture}
  ...
  \node[python, anchor=south] (tui) at ([xshift=-13mm,yshift=13mm]runner.north) {TUI};
  \node[python, anchor=south] (cli) at ([xshift=13mm,yshift=13mm]runner.north) {CLI};
  ...
  \node[data, anchor=west, text width=33mm] (pack) at ([xshift=21mm]prompt.east) {%
    ...
    {\scriptsize skills $\rightarrow$ /skills/ mounts}\\
  ...
  \begin{scope}[on background layer]
    \node[fit=(tui)(cli), inner sep=8pt] (ifacebox) {};
  ...
  % ===== edges =====
  \draw[bi] (tui.south) -- ++(0,-5mm) -| ([xshift=-4mm]runner.north);
  \draw[bi] (cli.south) -- ++(0,-5mm) -| ([xshift=4mm]runner.north);
